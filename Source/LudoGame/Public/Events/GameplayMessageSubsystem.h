...
LUDOGAME_API DECLARE_LOG_CATEGORY_EXTERN(LogGameplayMessageSubsystem, Log, All);

class UListenForGameplayMessage;
...
struct LUDOGAME_API FGameplayMessageListenerHandle
{
public:
	GENERATED_BODY()
 ...
 */
UCLASS()
class LUDOGAME_API UGameplayMessageSubsystem : public UGameInstanceSubsystem
{
	GENERATED_BODY()

	friend UListenForGameplayMessage;
