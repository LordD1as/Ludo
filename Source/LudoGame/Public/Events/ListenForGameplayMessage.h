...
#include "ListenForGameplayMessage.generated.h"
 ...
 */
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FAsyncGameplayMessageDelegate, UListenForGameplayMessage*, ProxyObject, FGameplayTag, ActualChannel);

/**
 * 
 */
UCLASS()
class LUDOGAME_API UListenForGameplayMessage : public UCancellableAsyncAction
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = Messaging, meta = (WorldContext = "WorldContextObject", BlueprintInternalUseOnly = "true"))
		static UListenForGameplayMessage* ListenForGameplayMessages(UObject* WorldContextObject, FGameplayTag Channel, UScriptStruct* PayloadType, EGameplayMessageMatch MatchType = EGameplayMessageMatch::ExactMatch);
